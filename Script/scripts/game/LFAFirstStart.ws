function LFASetDefaultOnFirstStart()
{
	...
	if (!DefaultSet)
	{
		...
		theGame.GetInGameConfigWrapper().SetVarValue('LFArmorsHeavy', 'HAStrongAttack', "-20");
		...
		theGame.GetInGameConfigWrapper().SetVarValue('LFArmorsHeavy', 'HARoll', "-15");
		...
		theGame.GetInGameConfigWrapper().SetVarValue('LFArmorsLight', 'LADodge', "12");
		theGame.GetInGameConfigWrapper().SetVarValue('LFArmorsLight', 'LARoll', "15");
		...
		theGame.GetInGameConfigWrapper().SetVarValue('LFArmorResistance', 'ResistLight', "-25");
